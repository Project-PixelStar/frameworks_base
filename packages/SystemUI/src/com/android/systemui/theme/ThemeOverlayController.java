...
public class ThemeOverlayController implements CoreStartable, Dumpable {
    ...
    protected static final String OVERLAY_BERRY_BLACK_THEME =
            "com.pixelstar.overlay.customization.blacktheme";
	...
	private final ConfigurationListener mConfigurationListener = new ConfigurationListener() {
    	...
    	public void onUiModeChanged() {
    	    ...
    	    setBootColorProps(); // Add this line to set boot color properties when UI mode changes
    	}
	
    	@Override
    	public void onThemeChanged() {
    	    setBootColorProps(); // Add this line to set boot color properties when theme changes
    	}
	};
    ...
    public void start() {
        ...
        mSystemSettings.registerContentObserverForUser(
                Settings.System.getUriFor(Settings.System.QS_PANEL_TILE_HAPTIC),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
